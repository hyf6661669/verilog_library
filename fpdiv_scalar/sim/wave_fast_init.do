...
add wave -position insertpoint -expand -group MAIN_SIGNALS sim:/tb_top/u_dut/frac_divisor_hi_q
add wave -position insertpoint -expand -group MAIN_SIGNALS sim:/tb_top/u_dut/frac_divisor_lo_d
add wave -position insertpoint -expand -group MAIN_SIGNALS sim:/tb_top/u_dut/frac_divisor_lo_q
...
add wave -position insertpoint -expand -group QUO_REG sim:/tb_top/u_dut/quo_m1_iter_d
