...
add wave -position insertpoint -group SPECIAL_SIGNALS {sim:/tb_top/u_dut/res_is_nan_d}
add wave -position insertpoint -group SPECIAL_SIGNALS {sim:/tb_top/u_dut/res_is_inf_d}
add wave -position insertpoint -group SPECIAL_SIGNALS {sim:/tb_top/u_dut/res_is_exact_zero_d}
add wave -position insertpoint -group SPECIAL_SIGNALS {sim:/tb_top/u_dut/op_invalid_d}
add wave -position insertpoint -group SPECIAL_SIGNALS {sim:/tb_top/u_dut/res_is_sqrt_2_d}
add wave -position insertpoint -group SPECIAL_SIGNALS {sim:/tb_top/u_dut/early_finish}
...
add wave -position insertpoint -group S0_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_neg_1[0]}
add wave -position insertpoint -group S0_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_neg_0[0]}
add wave -position insertpoint -group S0_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_pos_1[0]}
add wave -position insertpoint -group S0_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_pos_2[0]}
add wave -position insertpoint -group S0_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/u_r4_qds_s0/rem_i}
add wave -position insertpoint -group S0_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/u_r4_qds_s0/qds_sign}
add wave -position insertpoint -group S0_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_rt_dig[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/mask_csa_ext[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/rt}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/rt_m1}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_neg_2[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_neg_1[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_pos_1[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_pos_2[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_f_r_s[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_f_r_c[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_rt[0]}
add wave -position insertpoint -group S0_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_rt_m1[0]}


add wave -position insertpoint -group S1_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_neg_1[1]}
add wave -position insertpoint -group S1_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_neg_0[1]}
add wave -position insertpoint -group S1_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_pos_1[1]}
add wave -position insertpoint -group S1_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/m_pos_2[1]}
add wave -position insertpoint -group S1_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/g_s1_qds_no_spec/u_r4_qds_s1/rem_i}
add wave -position insertpoint -group S1_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/g_s1_qds_no_spec/u_r4_qds_s1/qds_sign}
add wave -position insertpoint -group S1_ITER -radix binary {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_rt_dig[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/mask_csa_ext[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_neg_2[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_neg_1[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_pos_1[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val_pos_2[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/sqrt_csa_val[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_f_r_s[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_f_r_c[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_rt[1]}
add wave -position insertpoint -group S1_ITER {sim:/tb_top/u_dut/u_fpsqrt_r16_block/nxt_rt_m1[1]}
...
add wave -position insertpoint -expand -group POST {sim:/tb_top/u_dut/guard_bit_rt_m1}
add wave -position insertpoint -expand -group POST {sim:/tb_top/u_dut/round_bit_rt_m1}
