...
add wave -position insertpoint -expand -group S0_ITER sim:/tb_top/u_dut/a0[0]
add wave -position insertpoint -expand -group S0_ITER sim:/tb_top/u_dut/a2[0]
add wave -position insertpoint -expand -group S0_ITER sim:/tb_top/u_dut/a3[0]
add wave -position insertpoint -expand -group S0_ITER sim:/tb_top/u_dut/a4[0]
...
add wave -position insertpoint -expand -group S1_ITER sim:/tb_top/u_dut/a0[1]
add wave -position insertpoint -expand -group S1_ITER sim:/tb_top/u_dut/a2[1]
add wave -position insertpoint -expand -group S1_ITER sim:/tb_top/u_dut/a3[1]
add wave -position insertpoint -expand -group S1_ITER sim:/tb_top/u_dut/a4[1]
