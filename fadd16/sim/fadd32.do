...
#add wave -position insertpoint -group CLOSE_LZA_OPA_LARGER {sim:/tb_top/u_dut/u_lza_opa_larger/lzc_in_rsh0}
#add wave -position insertpoint -group CLOSE_LZA_OPA_LARGER {sim:/tb_top/u_dut/u_lza_opa_larger/lzc_in_rsh1}
#add wave -position insertpoint -group CLOSE_LZA_OPA_LARGER {sim:/tb_top/u_dut/u_lza_opa_larger/lzc_in_temp}
#add wave -position insertpoint -group CLOSE_LZA_OPA_LARGER {sim:/tb_top/u_dut/u_lza_opa_larger/lzc_in}
#add wave -position insertpoint -group CLOSE_LZA_OPA_LARGER {sim:/tb_top/u_dut/u_lza_opa_larger/exp_limit}
#add wave -position insertpoint -group CLOSE_LZA_OPA_LARGER {sim:/tb_top/u_dut/u_lza_opa_larger/exp_limit_mask}

#add wave -position insertpoint -group CLOSE_LZA_OPB_LARGER {sim:/tb_top/u_dut/u_lza_opb_larger/lzc_in_rsh0}
#add wave -position insertpoint -group CLOSE_LZA_OPB_LARGER {sim:/tb_top/u_dut/u_lza_opb_larger/lzc_in_rsh1}
#add wave -position insertpoint -group CLOSE_LZA_OPB_LARGER {sim:/tb_top/u_dut/u_lza_opb_larger/lzc_in_temp}
#add wave -position insertpoint -group CLOSE_LZA_OPB_LARGER {sim:/tb_top/u_dut/u_lza_opb_larger/lzc_in}
#add wave -position insertpoint -group CLOSE_LZA_OPB_LARGER {sim:/tb_top/u_dut/u_lza_opb_larger/exp_limit}
#add wave -position insertpoint -group CLOSE_LZA_OPB_LARGER {sim:/tb_top/u_dut/u_lza_opb_larger/exp_limit_mask}
